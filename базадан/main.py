...
def start_command(message):
    photo_url = 'https://i.pinimg.com/1200x/93/62/31/936231a95115433c74f2c731ceacdf07.jpg'
    bot.send_message(message.chat.id, photo=photo_url, caption= """🤠 Привет! Я бот-менеджер проектов
...
★ /skills - используй для выбора проект для которого нужно выбрать навык ↜

★ /projects - используй чтоб вывести проекты →

★ /delete - используй чтоб удалить проект ✁

★ /update_projects - используй чтобы обновить проект ✐
